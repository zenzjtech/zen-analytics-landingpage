...
- **Description**: Added preloading for critical above-the-fold images to prioritize loading
- **Changes Made**:
  - Added `<link rel="preload">` for the first carousel image in the marketing layout
- **Impact**: Prioritizes loading of the first carousel image for better perceived performance
- **Author**: Cascade
